...
Status: implemented and deployed, hardware transition acceptance unmeasured (2026-09-11). This opens only transition scheduling/resource reuse; R14 visual changes remain deferred.
