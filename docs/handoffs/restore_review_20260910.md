...
The03:13 set was subsequently compacted to `.runtime/recovery-20260910-031300.tar.gz`, SHA-256 `759180ea8571ee4d836b6b8b5b2aa1e6f3ff3ac4f6926ae371bff01bd423f50f`,13,004,763,338 bytes. Its complete decompressed stream matches `81e5f0e3b3935da15b35ddf6c45ed0f0dc923b85513ef36517bfb86eefe5ae03` and29,635,358,720 bytes;7,893 safe members and required recovery keys were retained. This took342.033seconds. The compressed0600 manifest and original historical metadata are both preserved. The later05:26 raw archive remains intact.

The workspace uses transparent filesystem compression: apparent raw tar sizes were substantially larger than allocated blocks. Consequently explicit gzip saved less actual free space than the logical sizes suggest. After both verified replacements approximately24GiB was free, while the current database occupied15GiB physically and30GiB logically. The managed cold-backup writer now checks a4GiB actual free-block reserve before stopping the writer and during archive writes. On failure it removes its partial archive before restarting the unchanged database. Five focused backup tests cover normal completion, safe failure restart, pre-stop low-space refusal and the streaming reserve. This avoids treating an assumed compression ratio as a space guarantee.
