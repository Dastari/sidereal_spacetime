...
| Catalog sheets, exploded view and network diagram renders | `scripts/art_library/ship_component_sheets.py`, `ship_component_network.py` |
| Exported proposal art (LFS) | `assets/art-library/ship-components/r001/glb/<id>.glb`, `manifest.json` |
