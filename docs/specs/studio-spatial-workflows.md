...
- Map markers show cached snapshots of actual installed celestial assets, with independent physical-radius outlines and accessible fallback/loading indicators. Use bounded snapshot generation and cache by source identity rather than a renderer per marker.
