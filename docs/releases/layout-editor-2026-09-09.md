...
`npm run stop:dashboard` and `npm run dev:dashboard`. Dashboard PID is 3321167;
...
This activation exposes the completed local draft editor. Blueprint publication,
live ship refit and capture-live remain separate, unavailable authority stages.
