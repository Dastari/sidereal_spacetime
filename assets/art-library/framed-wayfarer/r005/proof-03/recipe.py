...
def build(out,full):
 ...
 import armor_block_kit_plan as plan
 ...
 for record in manifest['models']:
  ...
  if p['kind']=='span':
   ...
   m.rail('upper-stepped-shoulder',x0,x1,[(depth,H-band),(outer-.125,H-band),(outer,H-band+.125),(outer,H-.0625),(outer-.0625,H),(depth,H)])
