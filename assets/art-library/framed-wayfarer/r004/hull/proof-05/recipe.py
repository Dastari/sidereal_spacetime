...
def side(slug, variant, mats, pair=None, width=2, height=3):
    ...
    m.box('cyan-rail-recess', .492, .499, max(-half, lens_center - .36), min(half, lens_center + .36),
          .14, .255, 'black', .008)
    m.box('cyan-rail-lens', .499, .5, max(-half, lens_center - .29), min(half, lens_center + .29),
          .174, .218, 'black', 0, material='cyan')
