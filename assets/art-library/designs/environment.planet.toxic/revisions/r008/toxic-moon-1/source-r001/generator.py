...
palette=[('planets--toxic-moon-1-olive-crust', (0.027, 0.045, 0.012), 0.76), ('planets--toxic-moon-1-acid-rim', (0.34, 0.48, 0.018), 0.62), ('planets--toxic-moon-1-dark-cavity', (0.005, 0.011, 0.003), 0.91), ('planets--toxic-moon-1-olive-fracture', (0.06, 0.09, 0.018), 0.73), ('planets--toxic-moon-1-wet-chemical-fault', (0.28, 0.4, 0.006), 0.35), ('planets--toxic-moon-1-yellow-green-upper-crust', (0.52, 0.65, 0.048), 0.6)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--toxic-moon-1-r001'
 return obj
...
for name,parts in forms:
 ...
 for obj in parts:
  for face in obj.data.polygons:
   ...
   if face.material_index==0 and face.normal.z>.62 and q.z>.09 and field<0.24:face.material_index=5

kit={'schema':'sidereal.native-planet-kit.v1','layout':'toxic-moon-craters','coveredReferenceIds':['planets--toxic-moon-1'],'compositionRecipe':{'referenceId': 'planets--toxic-moon-1', 'layoutSeed': 1747, 'scales': [0.4, 0.38, 0.42, 0.39, 0.41, 0.38, 0.43, 0.39, 0.4, 0.37, 0.42, 0.4], 'variantOffset': 1, 'hero': 0},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
