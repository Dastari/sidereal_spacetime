...
for flight,count,x0,x1,base,direction in [('a',8,.20,1.80,.1875,1),('b',7,2.20,3.80,1.875,-1)]:
 ...
 if flight=='a':box(group,'final-riser',(x0,lastY,top-.1875),(x1,lastY+.03125,1.71875),'enamel',.002)
 # Flight B final riser is the existing native upper floor edge, not a duplicate plate.
...
box('stair-aperture-edge','back',(0,5.96875,3),(4,6,3.375),'frame',0)
box('stair-aperture-edge','front-left',(0,1.96875,3),(2.20,2,3.375),'frame',0)
box('stair-aperture-edge','front-right',(3.80,1.96875,3),(4,2,3.375),'frame',0)
box('stair-aperture-edge','front-under-threshold',(2.20,1.96875,3),(3.80,2,3.1875),'frame',0)
