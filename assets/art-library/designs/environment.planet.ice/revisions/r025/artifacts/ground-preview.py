...
out=Path('/root/sidereal_spacetime/output/playwright/planet-reference-20260914/ice-r025');bpy.ops.wm.open_mainfile(filepath=str(out/'kit.blend'));scene=bpy.context.scene
