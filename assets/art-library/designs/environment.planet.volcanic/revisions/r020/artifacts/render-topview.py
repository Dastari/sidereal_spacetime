...
c=bpy.context.scene.camera;c.location=(1,-1,10);c.rotation_euler=(Vector((0,0,.15))-c.location).to_track_quat('-Z','Y').to_euler();c.data.ortho_scale=12.5
bpy.context.scene.render.filepath=str(out/'regional-topview.png');bpy.ops.render.render(write_still=True)
