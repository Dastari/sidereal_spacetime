...
palette=[('planets--rocky-moon-2-crust', (0.3, 0.27, 0.38), 0.91), ('planets--rocky-moon-2-rim', (0.5, 0.44, 0.58), 0.87), ('planets--rocky-moon-2-cavity', (0.028, 0.023, 0.045), 0.97), ('planets--rocky-moon-2-fracture-wall', (0.105, 0.08, 0.15), 0.92), ('planets--rocky-moon-2-cool-fault', (0.19, 0.16, 0.25), 0.91), ('planets--rocky-moon-2-pale-fracture', (0.61, 0.55, 0.69), 0.85)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--rocky-moon-2-r001'
 return obj
...
kit={'schema':'sidereal.native-planet-kit.v1','layout':'solid-moon-craters','coveredReferenceIds':['planets--rocky-moon-2'],'compositionRecipe':{'referenceId': 'planets--rocky-moon-2', 'layoutSeed': 203, 'scales': [0.4, 0.38, 0.42, 0.37, 0.41, 0.39, 0.43, 0.38, 0.4, 0.37, 0.42, 0.39], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
