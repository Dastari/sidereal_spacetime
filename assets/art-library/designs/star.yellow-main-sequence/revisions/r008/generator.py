...
for face in body.data.polygons:
 ...
 hot=abs(flow)<.18 or (abs(branch)<.105 and flow>.15)
 face.material_index=3 if d<.58 else 4 if d<.91 else 5 if hot or .94<d<1.04 else 1 if abs(flow)<.52 else 0 if flow>-.9 else 2
