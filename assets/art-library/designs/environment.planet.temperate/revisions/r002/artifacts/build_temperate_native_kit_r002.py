"""Native continental Temperate2 candidate, retaining reviewed Ocean7 PBR assets."""
...
for index,outline in enumerate(contours):
 ...
 kit['variants'].append(dict(name=name,positions=positions,normals=normals,uvs=uvs,indices=indices,triangleMaterials=triangleMaterials));obj['role']='planet';obj['authoring']='native-temperate-r002'
