...
for o in bpy.data.objects:
 if o.name.startswith(('GEO-REVIEW-floor','GEO-REVIEW-height-gauge','GEO-REVIEW-roof-datum')):o.hide_render=True
...
cam=scene.camera;cam.location=(10,-10,10);cam.rotation_euler=(Vector((3,2,.5))-cam.location).to_track_quat('-Z','Y').to_euler();cam.data.ortho_scale=11.5
for o in bpy.data.objects:
