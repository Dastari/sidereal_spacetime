...
Run: blender -b --python scripts/art_library/build_crystal_native_kit_r002.py -- NEW_OUTPUT
"""
...
def make(name,verts,faces,roles):
 ...
 bm=bmesh.new();bm.from_mesh(mesh);bmesh.ops.recalc_face_normals(bm,faces=bm.faces);bm.to_mesh(mesh);bm.free();o['role']='planet';o['authoring']='native-crystal-r002';return o
