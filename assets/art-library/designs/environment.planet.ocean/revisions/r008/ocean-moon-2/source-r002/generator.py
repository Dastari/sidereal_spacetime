...
palette=[('planets--ocean-moon-2-crust', (0.1, 0.28, 0.44), 0.91), ('planets--ocean-moon-2-rim', (0.48, 0.7, 0.79), 0.87), ('planets--ocean-moon-2-cavity', (0.007, 0.025, 0.052), 0.97), ('planets--ocean-moon-2-fracture-wall', (0.025, 0.1, 0.2), 0.92), ('planets--ocean-moon-2-cool-fault', (0.045, 0.36, 0.48), 0.91), ('planets--ocean-moon-2-pale-fracture', (0.72, 0.86, 0.87), 0.85), ('planets--ocean-moon-2-green-cap', (0.19, 0.4, 0.04), 0.9), ('planets--ocean-moon-2-sunlit-green-cap', (0.53, 0.7, 0.22), 0.88), ('planets--ocean-moon-2-blue-mineral-cover', (0.025, 0.37, 0.61), 0.88)]

palette.append(('pale-white-upper-district',(.82,.91,.94),.86))
materials=[]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--ocean-moon-2-r002'
 return obj
...
for form_name,parts in forms:
 ...
 for obj in parts:
  for face in obj.data.polygons:
   ...
   elif field > 0.8-.20 and q.x>.30:face.material_index=8
...
kit={'schema':'sidereal.native-planet-kit.v1','layout':'hybrid-moon-craters','coveredReferenceIds':['planets--ocean-moon-2'],'compositionRecipe':{'referenceId': 'planets--ocean-moon-2', 'layoutSeed': 1181, 'scales': [0.4, 0.38, 0.42, 0.39, 0.41, 0.38, 0.43, 0.39, 0.4, 0.37, 0.42, 0.4], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
