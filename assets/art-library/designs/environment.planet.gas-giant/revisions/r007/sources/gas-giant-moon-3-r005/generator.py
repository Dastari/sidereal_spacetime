...
palette=[('planets--gas-giant-moon-3-crust', (0.45, 0.35, 0.51), 0.91), ('planets--gas-giant-moon-3-rim', (0.66, 0.53, 0.73), 0.87), ('planets--gas-giant-moon-3-cavity', (0.034, 0.021, 0.047), 0.97), ('planets--gas-giant-moon-3-fracture-wall', (0.17, 0.11, 0.23), 0.92), ('planets--gas-giant-moon-3-cool-fault', (0.31, 0.23, 0.38), 0.91), ('planets--gas-giant-moon-3-pale-fracture', (0.76, 0.61, 0.78), 0.85), ('gas-giant-moon-3-violet-mineral', (0.24, 0.014, 0.58), 0.1), ('gas-giant-moon-3-pink-mineral', (0.57, 0.021, 0.32), 0.12)]
materials=[]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--gas-giant-moon-3-r001'
 return obj
...
for form_name,parts in forms:
 ...
 for obj in parts:
  for face in obj.data.polygons:
   ...
   if face.material_index in (0,1,5) and .38<r<1.03 and -.12<angle<1.38 and center.z>-.08:
    face.material_index=7 if .40<angle<.98 and r>.51 else 6;mineral_faces+=1
assert mineral_faces>0

kit={'schema':'sidereal.native-planet-kit.v1','layout':'solid-moon-craters','coveredReferenceIds':['planets--gas-giant-moon-3'],'compositionRecipe':{'referenceId': 'planets--gas-giant-moon-3', 'layoutSeed': 743, 'scales': [0.44, 0.41, 0.39, 0.43, 0.4, 0.42, 0.38, 0.44, 0.41, 0.4, 0.43, 0.39], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
...
for role in (6,7):
 ...
 kit['materials'][role].update(ior=2.2,clearcoatFactor=1,clearcoatRoughnessFactor=.08)

# Explicit art interpretation: existing native mineral faces emit bounded colored light.
