...
palette=[('planets--gas-giant-moon-2-crust', (0.34, 0.3, 0.39), 0.91), ('planets--gas-giant-moon-2-rim', (0.55, 0.49, 0.61), 0.87), ('planets--gas-giant-moon-2-cavity', (0.03, 0.025, 0.041), 0.97), ('planets--gas-giant-moon-2-fracture-wall', (0.13, 0.105, 0.17), 0.92), ('planets--gas-giant-moon-2-cool-fault', (0.23, 0.2, 0.29), 0.91), ('planets--gas-giant-moon-2-pale-fracture', (0.64, 0.56, 0.68), 0.85)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--gas-giant-moon-2-r001'
 return obj
...
kit={'schema':'sidereal.native-planet-kit.v1','layout':'solid-moon-craters','coveredReferenceIds':['planets--gas-giant-moon-2'],'compositionRecipe':{'referenceId': 'planets--gas-giant-moon-2', 'layoutSeed': 631, 'scales': [0.38, 0.4, 0.42, 0.37, 0.39, 0.41, 0.38, 0.43, 0.4, 0.37, 0.42, 0.39], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
