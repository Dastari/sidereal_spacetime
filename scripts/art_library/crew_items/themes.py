...
THEMES = {
    ...
    "orion": dict(primary=(0.52, 0.40, 0.72), secondary=(0.034, 0.037, 0.084), accent=(0.66, 0.026, 0.078),
                  ...
                  grip=(0.03, 0.03, 0.065), emit_a=((0.10, 0.55, 1.0), 8.0), emit_b=((1.0, 0.10, 0.16), 7.0),
                  glass=(0.35, 0.72, 1.0)),
    ...
    "engineer": dict(primary=(0.90, 0.46, 0.025), secondary=(0.05, 0.06, 0.12), accent=(0.95, 0.72, 0.04),
                     ...
                     grip=(0.04, 0.045, 0.09), emit_a=((0.10, 0.75, 1.0), 8.0), emit_b=((1.0, 0.45, 0.06), 8.0),
                     glass=(0.40, 0.80, 1.0)),
    ...
    "security": dict(primary=(0.07, 0.12, 0.40), secondary=(0.02, 0.022, 0.05), accent=(0.10, 0.40, 1.0),
                     ...
                     grip=(0.03, 0.03, 0.05), emit_a=((0.15, 0.55, 1.0), 9.0), emit_b=((1.0, 0.12, 0.10), 7.0),
                     glass=(0.30, 0.60, 1.0)),
    ...
    "medic": dict(primary=(0.82, 0.80, 0.86), secondary=(0.10, 0.10, 0.16), accent=(0.75, 0.02, 0.04),
                  ...
                  grip=(0.05, 0.05, 0.09), emit_a=((0.15, 1.0, 0.45), 8.0), emit_b=((1.0, 0.15, 0.30), 8.0),
                  glass=(0.55, 1.0, 0.75)),
    ...
    "salvage": dict(primary=(0.50, 0.20, 0.05), secondary=(0.10, 0.08, 0.07), accent=(0.95, 0.62, 0.03),
                    ...
                    grip=(0.06, 0.05, 0.045), emit_a=((1.0, 0.55, 0.08), 8.0), emit_b=((1.0, 0.30, 0.04), 9.0),
                    glass=(1.0, 0.65, 0.25)),
    ...
    "recon": dict(primary=(0.16, 0.22, 0.09), secondary=(0.03, 0.04, 0.03), accent=(0.34, 0.36, 0.26),
                  ...
                  grip=(0.035, 0.04, 0.03), emit_a=((0.20, 1.0, 0.25), 9.0), emit_b=((0.55, 1.0, 0.15), 8.0),
                  glass=(0.30, 1.0, 0.40)),
}
    ...
    for name, th in THEMES.items():
        ...
        for s in ITEM_SLOTS:
            ...
            if s.startswith("emit"):
                ...
                slots[s] = {"color": list(v), "emissive": list(v), "emissiveStrength": 0.6, "roughness": rough, "metallic": metal, "alpha": 0.45}
            else:
