...
def render(directory):
    ...
    if manifest['stage'] == 'complete-family-independent-review-candidate':
        ...
        shots += [
            ...
            ('single-identity-standard', [('armor-identity-w200-h300', (0, 0, 0))],
             (.25, 0, 1.5), (7, -4, 3.7), 4.3, 'all'),
            ('joined-cyan-pocket-close', joined('identity'), (.28, 0, .20), (7, -2, 2.2), 1.5, 'all'),
            ...
            ('fitted-bow-terminal-close', [('front-bow-bumper', (-2, 13, -.25)),
                                          ('front-diagonal-cheek', (1, 11, -.25))],
             (2, 13.125, .525), (4, 6, 3), 2.8, 'all'),
            ('bow-cyan-pocket-close', [('front-bow-bumper', (0, 0, 0))],
             (2, .625, .17), (0, 7, 2.5), 1.6, 'all'),
        ]
    captures = []
