...
col=bpy.data.collections['corner-buttress']
for o in col.objects:o.hide_render=False;o.hide_set(False)
s.render.resolution_x=1000;s.render.resolution_y=800;s.cycles.samples=64;c.data.ortho_scale=2.9;c.location=(4,3.5,4.0);c.rotation_euler=(Vector((1,1,2.2))-c.location).to_track_quat('-Z','Y').to_euler();s.render.filepath=str(out/'blender-grille-close.png');bpy.ops.render.render(write_still=True)
