...
import{referenceMaterial}from'./planet_reference_materials';import{composeToxicFog}from'./toxic_fog_composition_r003';
const kit=JSON.parse(readFileSync('output/playwright/planet-reference-20260914/toxic-fog-r003/kit.json','utf8'));
