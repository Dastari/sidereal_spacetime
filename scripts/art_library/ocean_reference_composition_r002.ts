...
export function composeOceanReference(kit:NativePlanetKit,seed:number,lod:0|1|2){
 ...
 const anchors:Vec[]=[];
 const layouts=[
  {name:'steep-island',scale:.25,height:.65},
  {name:'archipelago',scale:.21,height:.56},
  {name:'long-island',scale:.23,height:.46},
  {name:'archipelago',scale:.17,height:.56},
  {name:'steep-island',scale:.18,height:.65},
  {name:'lagoon-atoll',scale:.13,height:0},
  {name:'steep-island',scale:.23,height:.65},
  {name:'long-island',scale:.22,height:.46},
  {name:'archipelago',scale:.19,height:.56},
  {name:'steep-island',scale:.21,height:.65},
 ];
 for(let i=0;i<layouts.length;i++){
  ...
  if(spec.height){
   ...
   const groves=spec.name==='archipelago'?[{x:-.55,y:.21,scale:.058,height:.38},{x:.27,y:-.24,scale:.053,height:.56}]:[{x:-.10,y:.08,scale:.085,height:spec.height},{x:.19,y:-.08,scale:.072,height:spec.height}];
