...
export function composeToxicMoonReference(
  kit: NativePlanetKit,
  seed: number,
  lod: 0 | 1 | 2,
  diagnostic = false,
  ...
  if (
    !recipe ||
    !["planets--toxic-moon-1", "planets--toxic-moon-2"].includes(
      recipe.referenceId,
    ) ||
    ...
    throw new Error("Explicit toxic moon composition recipe required");
