...
export function composeRockyMoonReference(
  kit: NativePlanetKit,
  seed: number,
  lod: 0 | 1 | 2,
  diagnostic = false,
  ...
  if (diagnostic)
    ...
    for (let i = 0; i < 14; i++) {
      ...
      regions.push({
        ...
        scale: [0.33, 0.27, 0.31, 0.24, 0.32, 0.26, 0.29][i % 7],
        angle: random() * Math.PI * 2,
        name: i % 2 ? "lunar-impact-b" : "lunar-impact-a",
        id: `planets--rocky-moon-1/impact-${i}`,
      });
    }
