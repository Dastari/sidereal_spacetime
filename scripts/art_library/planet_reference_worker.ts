...
self.onmessage = async (event) => {
  ...
  try {
    ...
    const batches =
      kit.layout === "crystal-moon-native-body"
        ? kit.nativePartRanges
          ? composePartitionedCrystalMoonReference(kit, seed, lod)
          : composeNativeCrystalMoonReference(kit, seed, lod)
