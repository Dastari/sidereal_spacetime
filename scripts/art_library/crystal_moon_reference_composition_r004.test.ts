...
for (const id of ["crystal-moon-1", "crystal-moon-2"]) {
  ...
  it(`${id} preserves a closed readable body in distributed NullEngine surface rays`, () => {
