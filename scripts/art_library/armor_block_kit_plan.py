...
def make_plan(full=False):
 ...
 if full:
  ...
  p.boundary('wayfarer',[[int(v*32) for v in q] for q in boundary],[3,3,3,1.5,1.5,1.5,1.5,1.5,3,3],['plain',['red-service','red-service','utility','utility','identity','plain','vent','plain','plain'],'utility','plain','vent','plain','vent','plain','utility',['plain','plain','vent','plain','identity','utility','utility','red-service','red-service']],z=.1875)
  ...
  p.fixture('identity-bay',[p.place(p.span(2,3,'identity'))])
