...
Run: blender -b --python scripts/art_library/build_ocean_native_kit.py -- NEW_OUTPUT
"""
...
palette=[('deep-cobalt',(.014,.073,.32),.34),('shelf-blue',(.014,.23,.49),.36),('shallow-turquoise',(.035,.58,.56),.38),('pale-beach',(.82,.65,.35),.84),('grey-coastal-rock',(.25,.24,.28),.89),('cliff-shadow',(.085,.13,.16),.93),('plateau-green',(.17,.37,.033),.88),('canopy-bright',(.25,.51,.028),.87),('canopy-dark',(.046,.22,.017),.93),('tree-bark',(.14,.065,.023),.93)]
materials=[]
...
def objmesh(name,verts,faces,roles):
 ...
 o['role']='planet';o['authoring']='native-ocean-r001';return o
...
def island(name,x,y,sx,sy,h,phase=0):
 ...
 profile=[(1.16,-.13),(1.16,.008),(1.01,.021),(.87,.042),(.79,.075),(.65,.092),(.65,h-.045),(.59,h)]
 verts=[]
...
n=32;verts=[]
profile=[(.34,-.06),(.34,.012),(.42,.035),(.48,.079),(.51,.16),(.64,.16),(.69,.065),(.85,.033),(1,.012),(1,-.11)]
