...
for job in JOBS:
 ...
 scene['design_id']=job['design_id'];scene['revision']=2;scene['specification']=json.dumps(s);scene['publication']='unsigned draft'
 ...
 print('CARGO_R002_COMPLETE',job['slug'],flush=True)
