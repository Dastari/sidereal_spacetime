...
parts=[o for o in scene.objects if o.type=='MESH' and o.name.startswith('GEO-battered-region-a')]
assert parts
...
scene.render.resolution_x=650;scene.render.resolution_y=650;scene.render.resolution_percentage=100;scene.render.filepath=str(out/'native-a-shoulders-preview.png');bpy.ops.render.render(write_still=True)
