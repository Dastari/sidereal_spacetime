...
Run: blender -b --python scripts/art_library/build_rocky_native_kit.py -- NEW_OUTPUT
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-rocky-r001'
 return obj
...
def crater(name,size,phase,broken=False):
 ...
 profile=[(.30,.035),(.34,.055),(.40,.10),(.44,.29),(.51,.40),(.64,.41),(.72,.30),(.91,.11),(1.0,-.10)]
 verts=[]
