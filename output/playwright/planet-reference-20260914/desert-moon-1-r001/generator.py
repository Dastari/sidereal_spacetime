...
palette=[('planets--desert-moon-1-crust', (0.66, 0.49, 0.48), 0.91), ('planets--desert-moon-1-rim', (0.86, 0.72, 0.66), 0.87), ('planets--desert-moon-1-cavity', (0.05, 0.016, 0.02), 0.97), ('planets--desert-moon-1-fracture-wall', (0.23, 0.11, 0.13), 0.92), ('planets--desert-moon-1-cool-fault', (0.4, 0.28, 0.29), 0.91), ('planets--desert-moon-1-pale-fracture', (0.9, 0.79, 0.73), 0.85)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--desert-moon-1-r001'
 return obj
...
kit={'schema':'sidereal.native-planet-kit.v1','layout':'solid-moon-craters','coveredReferenceIds':['planets--desert-moon-1'],'compositionRecipe':{'referenceId': 'planets--desert-moon-1', 'layoutSeed': 307, 'scales': [0.42, 0.39, 0.43, 0.4, 0.38, 0.41, 0.44, 0.39, 0.42, 0.4, 0.38, 0.43], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
