...
palette=[('planets--desert-moon-2-crust', (0.58, 0.15, 0.06), 0.91), ('planets--desert-moon-2-rim', (0.79, 0.28, 0.11), 0.87), ('planets--desert-moon-2-cavity', (0.055, 0.008, 0.004), 0.97), ('planets--desert-moon-2-fracture-wall', (0.25, 0.055, 0.02), 0.92), ('planets--desert-moon-2-cool-fault', (0.38, 0.09, 0.04), 0.91), ('planets--desert-moon-2-pale-fracture', (0.85, 0.35, 0.16), 0.85)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--desert-moon-2-r001'
 return obj
...
kit={'schema':'sidereal.native-planet-kit.v1','layout':'solid-moon-craters','coveredReferenceIds':['planets--desert-moon-2'],'compositionRecipe':{'referenceId': 'planets--desert-moon-2', 'layoutSeed': 419, 'scales': [0.39, 0.42, 0.38, 0.43, 0.4, 0.41, 0.39, 0.44, 0.38, 0.42, 0.4, 0.41], 'variantOffset': 1},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
