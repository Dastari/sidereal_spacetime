...
out=Path('/root/sidereal_spacetime/output/playwright/planet-reference-20260914/desert-r014')
bpy.ops.wm.open_mainfile(filepath=str(out/'kit.blend'))
names=['regional-cliff-head','regional-cliff-continuation','regional-cliff-end']
...
bpy.context.scene.render.filepath=str(out/'regional-cliff-preview.png');bpy.ops.render.render(write_still=True)
