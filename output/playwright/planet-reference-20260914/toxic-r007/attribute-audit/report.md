...
- `toxic-basin-group-a` texture `corrosion-5-albedo.png`: byte-identical.
- `toxic-basin-group-a` texture `corrosion-5-normal.png`: byte-identical.
- `toxic-basin-group-a` texture `corrosion-5-orm.png`: byte-identical.
...
- `toxic-basin-group-b` texture `corrosion-5-albedo.png`: byte-identical.
- `toxic-basin-group-b` texture `corrosion-5-normal.png`: byte-identical.
- `toxic-basin-group-b` texture `corrosion-5-orm.png`: byte-identical.
...
- `toxic-basin-group-c` texture `corrosion-5-albedo.png`: byte-identical.
- `toxic-basin-group-c` texture `corrosion-5-normal.png`: byte-identical.
- `toxic-basin-group-c` texture `corrosion-5-orm.png`: byte-identical.
...
- `ground-sphere` texture `corrosion-2-albedo.png`: byte-identical.
- `ground-sphere` texture `corrosion-2-normal.png`: byte-identical.
- `ground-sphere` texture `corrosion-2-orm.png`: byte-identical.
- `ground-sphere` texture `corrosion-3-albedo.png`: byte-identical.
- `ground-sphere` texture `corrosion-3-normal.png`: byte-identical.
- `ground-sphere` texture `corrosion-3-orm.png`: byte-identical.
- `ground-sphere` texture `corrosion-4-albedo.png`: byte-identical.
- `ground-sphere` texture `corrosion-4-normal.png`: byte-identical.
- `ground-sphere` texture `corrosion-4-orm.png`: byte-identical.
...
- `ground-sphere-medium` texture `corrosion-2-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-2-normal.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-2-orm.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-3-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-3-normal.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-3-orm.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-4-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-4-normal.png`: byte-identical.
- `ground-sphere-medium` texture `corrosion-4-orm.png`: byte-identical.
...
- `ground-sphere-low` texture `corrosion-2-albedo.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-2-normal.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-2-orm.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-3-albedo.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-3-normal.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-3-orm.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-4-albedo.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-4-normal.png`: byte-identical.
- `ground-sphere-low` texture `corrosion-4-orm.png`: byte-identical.
