...
palette=[('planets--toxic-moon-2-olive-crust', (0.065, 0.09, 0.018), 0.76), ('planets--toxic-moon-2-acid-rim', (0.48, 0.61, 0.055), 0.62), ('planets--toxic-moon-2-dark-cavity', (0.007, 0.013, 0.003), 0.91), ('planets--toxic-moon-2-olive-fracture', (0.1, 0.14, 0.022), 0.73), ('planets--toxic-moon-2-wet-chemical-fault', (0.36, 0.49, 0.014), 0.35), ('planets--toxic-moon-2-yellow-green-upper-crust', (0.69, 0.76, 0.12), 0.6)]
...
def mesh_object(name,verts,faces,roles):
 ...
 obj['role']='planet';obj['authoring']='native-planets--toxic-moon-2-r001'
 return obj
...
for name,parts in forms:
 ...
 for obj in parts:
  for face in obj.data.polygons:
   ...
   if face.material_index==0 and face.normal.z>.62 and q.z>.09 and field<0.58:face.material_index=5

kit={'schema':'sidereal.native-planet-kit.v1','layout':'toxic-moon-craters','coveredReferenceIds':['planets--toxic-moon-2'],'compositionRecipe':{'referenceId': 'planets--toxic-moon-2', 'layoutSeed': 1861, 'scales': [0.43, 0.4, 0.44, 0.39, 0.42, 0.41, 0.43, 0.4, 0.42, 0.39, 0.44, 0.41], 'variantOffset': 1, 'hero': 0},'materials':[{'name':name,'linearColor':list(color),'roughness':roughness} for name,color,roughness in palette],'variants':[]}
