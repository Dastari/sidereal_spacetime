...
const ids=['toxic-moon-1', 'toxic-moon-2'];
for(const id of ids){
...
it('retains complete native regional surfaces UVs normals and identities at every LOD',()=>{
 const a=composeToxicMoonReference(kit,38,0),b=composeToxicMoonReference(kit,38,2);
