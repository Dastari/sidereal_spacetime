...
import {composeOceanReference as previousComposition} from './ocean_reference_composition_r005';
import {expect,it} from 'vitest';
import {readFileSync} from 'node:fs';
import {createHash} from 'node:crypto';
import {composeOceanReference} from './ocean_reference_composition_r006';
import type {NativePlanetKit} from '../../packages/render/src/environment/native-planet-composition';
const kit=JSON.parse(readFileSync('output/playwright/planet-reference-20260914/ocean-r006/kit.json','utf8')) as NativePlanetKit;
