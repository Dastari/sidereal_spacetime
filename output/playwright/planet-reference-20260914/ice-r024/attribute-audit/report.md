...
- `ground-sphere` texture `ice-1-albedo.png`: byte-identical.
- `ground-sphere` texture `ice-1-orm.png`: byte-identical.
- `ground-sphere` texture `ice-2-albedo.png`: byte-identical.
- `ground-sphere` texture `ice-2-orm.png`: byte-identical.
- `ground-sphere` texture `ice-3-albedo.png`: byte-identical.
- `ground-sphere` texture `ice-3-orm.png`: byte-identical.
- `ground-sphere-medium` texture `ice-0-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `ice-0-orm.png`: byte-identical.
- `ground-sphere-medium` texture `ice-1-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `ice-1-orm.png`: byte-identical.
- `ground-sphere-medium` texture `ice-2-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `ice-2-orm.png`: byte-identical.
- `ground-sphere-medium` texture `ice-3-albedo.png`: byte-identical.
- `ground-sphere-medium` texture `ice-3-orm.png`: byte-identical.
- `ground-sphere-low` texture `ice-0-albedo.png`: byte-identical.
- `ground-sphere-low` texture `ice-0-orm.png`: byte-identical.
- `ground-sphere-low` texture `ice-1-albedo.png`: byte-identical.
- `ground-sphere-low` texture `ice-1-orm.png`: byte-identical.
- `ground-sphere-low` texture `ice-2-albedo.png`: byte-identical.
- `ground-sphere-low` texture `ice-2-orm.png`: byte-identical.
- `ground-sphere-low` texture `ice-3-albedo.png`: byte-identical.
- `ground-sphere-low` texture `ice-3-orm.png`: byte-identical.
