...
export function connect(
  ...
  for (const table of [
    ...
    connection.db.ownAuthoredFlightPhysics,
    connection.db.ownAuthoredFlightActuators,
    connection.db.ownAuthoredFlightPowerFittings,
    connection.db.ownPassengerGrants,
    connection.db.ownPassengerVisit,
    connection.db.currentPassengerInterior,
    connection.db.currentInteriorCrew,
