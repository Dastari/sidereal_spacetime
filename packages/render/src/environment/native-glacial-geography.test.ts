...
const kit:NativePlanetKit={schema:"sidereal.native-planet-kit.v1",layout:"glacial-geography",materials:[{name:"snow",linearColor:[1,1,1],roughness:.8}],variants:["snow-cluster-a","snow-cluster-b","snow-cluster-c","ice-bluff-a","ice-bluff-b","ice-canyon","sealing-core"].map(name=>({...form,name}))};
describe("native coherent glacial geography",()=>{
