...
const projections = [
  ...
  [instanceProjection, "id"],
  [deckProjection, "id"],
  [locationProjection, "characterId"],
  [doorProjection, "id"],
  [nativePressureProjection, "doorId"],
  [traversalProjection, "characterId"],
  [traversalLinkProjection, "id"],
  [stateProjection, "pocketsId"],
  [itemProjection, "id"],
  [containerProjection, "id"],
  [hotbarProjection, "slot"],
  [groundItemProjection, "id"],
