    ...
    <div className="app">
      <header className="app-header">
        ...
        <div className="account">
          <Status>Authoring foundation</Status>
        </div>
      </header>
            ...
            <main className="viewport editor">
              ...
              <div className="view-heading">
                <div>
                  ...
                  <h1>Wayfarer</h1>
                  <span className="ship-class">Imported Blender geometry</span>
                </div>
            ...
            <aside className="inspector">
              ...
              <Panel title="Authoring contract">
                <p className="fine-print">
                  Part placement, mounting rules, undo, persistent drafts and
                  live refits are specified in the implementation plan.
                </p>
                <a
          ...
          <main className="dashboard">
            ...
            {toolDetail && (
              <dialog open className="detail-dialog">
                <button className="close" onClick={() => setToolDetail(null)}>
                  Close
                </button>
                <h2>{toolDetail[0]}</h2>
                <p>{toolDetail[2]}</p>
